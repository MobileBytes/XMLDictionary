...
//! Project version number for XMLDictionary_RN.
FOUNDATION_EXPORT double XMLDictionary_RNVersionNumber;

//! Project version string for XMLDictionary_RN.
FOUNDATION_EXPORT const unsigned char XMLDictionary_RNVersionString[];

// In this header, you should import all the public headers of your framework using statements like #import <XMLDictionary_RN/PublicHeader.h>
